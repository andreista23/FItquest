...
namespace Fitquest.Migrations
{
    ...
    [Migration("20260203165752_FitnessPlans2")]
    partial class FitnessPlans2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitQuest.Models.Activity", b =>
                {
                    ...
                    b.Property<bool>("IsTrainerAssigned")
            ...
            modelBuilder.Entity("FitQuest.Models.AdminAccessCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitQuest.Models.Friendship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrainerActivityAssignment", b =>
                {
                    ...
                    b.Property<string>("ProofMessage")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("FitQuest.Models.Friendship", b =>
                {
                    b.HasOne("FitQuest.Models.User", "Addressee")
                        .WithMany()
                        .HasForeignKey("AddresseeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FitQuest.Models.User", "Requester")
                        .WithMany()
